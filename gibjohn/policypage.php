<?php include("view/header.php"); ?>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            ...
            <head>
                <title>GibJohn Tutoring - Privacy Policy</title>
            </head>
            ...
            <body>
                <div class="container_policy">
                    ...
                    <p>GibJohn Tutoring ("us", "we", or "our") operates the website <a href="http://www.gibjohntutoring.com">www.gibjohntutoring.com</a> (the "Service").</p>
                    ...
                    <p>Usage Data: We may...</p>
                    <!-- Include other sections of the privacy policy as needed -->
                </div>
            </body>
